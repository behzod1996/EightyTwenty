...
public abstract class Hilt_NewNoteFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_NewNoteFragment() {
    super();
  }

  Hilt_NewNoteFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((NewNoteFragment_GeneratedInjector) this.generatedComponent()).injectNewNoteFragment(UnsafeCasts.<NewNoteFragment>unsafeCast(this));
    }
  }
