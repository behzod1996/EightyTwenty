...
public abstract class Hilt_CategoryNoteFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CategoryNoteFragment() {
    super();
  }

  Hilt_CategoryNoteFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CategoryNoteFragment_GeneratedInjector) this.generatedComponent()).injectCategoryNoteFragment(UnsafeCasts.<CategoryNoteFragment>unsafeCast(this));
    }
  }
